<?php echo form_open('vaga/edit/'.$vaga['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="empresas_id" class="form-control">
				...
				{
					$selected = ($empresa['id'] == $vaga['empresas_id']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="titulo" value="<?php echo ($this->input->post('titulo') ? $this->input->post('titulo') : $vaga['titulo']); ?>" class="form-control" id="titulo" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="descritivo" class="form-control" id="descritivo"><?php echo ($this->input->post('descritivo') ? $this->input->post('descritivo') : $vaga['descritivo']); ?></textarea>
